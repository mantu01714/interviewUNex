...
function Interview() {
  ...
  return (
    <div className="px-10 md:px-28 lg:px-48 xl:px-80 mt-7">
      <div
        className="flex flex-col items-center justify-center border rounded-lg bg-white
      ...
      >
        ...
        <div className="w-full">
          ...
          <Input placeholder="e.g. Mantu Kumar" onChange={(event)=>setUserName(event.target.value)} />
        </div>
        <div className="w-full">
          <h2>Enter your Email</h2>
          <Input placeholder="e.g. mantu123@gmail.com" onChange={(event)=>setUserEmail(event.target.value)} />
        </div>
