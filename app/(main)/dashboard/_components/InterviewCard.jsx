...
function InterviewCard({interview,viewDetail=false}) {
    ...
    const copyLink=()=>{
      ...
      const onSend=()=>{
        window.location.href="mailto:mk642799@gmail.com?subject=interviewUNex Interview Link & body=Interview Link"+url
      }
  return (
    <div className='p-5 bg-white rounded-lg border'>
        ...
        { !viewDetail ?<div className='flex gap-3 w-full mt-5'>
            ...
            <Button className={'flex-1'} onClick={onSend}> <Send/> Send </Button>
        </div>
        :
